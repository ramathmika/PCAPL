...
int main(){
	...
	ret = clSetKernelArg(kernel1,0,sizeof(cl_mem),(void *)&abuff);
	ret = clSetKernelArg(kernel2,0,sizeof(cl_mem),(void *)&abuff);
	...
	ret = clEnqueueReadBuffer(cmdq,abuff,CL_TRUE,0,n*sizeof(int),B,0,NULL,NULL);
