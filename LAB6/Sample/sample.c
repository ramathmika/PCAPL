...
int main(){
	...
	cl_kernel kernel = clCreateKernel(program,"str_changeCase",&ret);
	...
	strres[len-1] = '\0';
	printf("\nResultant toggled string is: %s",strres);
	getchar();
	...
	printf("\nTotal time taken to execute the Kernel in milliseconds is %0.3f msec\n\n",tot_time/1000000);
	printf("\nTotal time taken to execute the whole program in seconds is %0.3f secs\n\n",(end-start)/(double)CLOCKS_PER_SEC);
